                    ...
                    <div className="text-sm w-full md:w-1/2">
                        ...
                        <div className="flex items-center gap-0.5 mt-1">
                            {Array(5).fill('').map((_, i) => (
                                product.rating > i ? (
                                    <svg key={`filled-${i}`} width="14" height="13" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <svg key={`empty-${i}`} width="14" height="13" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
