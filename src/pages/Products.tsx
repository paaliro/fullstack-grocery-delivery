                ...
                <div key={index} className="border-1 border-[#e1e3e6] rounded-md">
                    <div className="px-4 md:px-4 py-2">
                        <div className="flex justify-center">
                            <img src={data.imgPath} alt="items-img" className="max-w-28 md:max-w-36 h-30 md:h-fit cursor-pointer transform transition-transform duration-300 hover:scale-105" />
                        </div>
                        <div>
                            <div>
                                ...
                                <div className="flex justify-between items-baseline pt-3">
                                    ...
                                    <button className="flex gap-0.5 md:gap-2 border-1 text-xs md:text-lg border-[#feca65] px-1 md:px-3 py-0.5 rounded-xs md:rounded-sm bg-[#fff7e7] text-[#feca65] font-normal cursor-pointer">
                                        <img src="/images/updated-svg/cart_icon.svg" alt="cart-icon" className="w-2.5 md:w-4" />
                                        Add
                                    </button>
                                </div>
                            </div>
