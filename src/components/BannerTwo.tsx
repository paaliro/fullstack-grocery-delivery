...
const BannerTwo = () => {
    return <section className="px-6 md:px-24">
        <div className="relative">
            ...
            <div>
                <div className="absolute inset-0 flex flex-col items-center md:items-end md:justify-center pt-10 md:pt-0 md:pr-24">
                    <div className="md:mt-20 lg:mt-25">
                        <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold .text-brand mb-6 text-[#fdb81d]">Why We Are the Best?</h1>
