        ...
        <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-28 md:pb-0 px-4 md:pl-30 lg:pl-50">
                ...
                <div className="flex items-center mt-6 font-medium" >
                    <Link to="/products"><button className="group flex items-center gap-2 px-5 md:px-9 py-3 bg-primary hover:bg-primary-dull transition rounded text-white cursor-pointer bg-[#fdb81d]">Shop Now<img src="/images/white_arrow_icon.svg" alt="arrow-img" className="md:hidden" /></button></Link>
