    ...
    return <section className="px-6 md:px-24 mt-20 md:mt-22">
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex mt-12 mb-10 md:w-[55%]">
                ...
                <button onClick={() => console.log("Kuch toh hua, bhai")} className="md:px-12 px-8 text-white bg-[#fdb81d] rounded-r-md py-3 text-md hover:bg-yellow-600 transition-colors cursor-pointer">Subscribe</button>
            </div>
        </div>
    </section>
}
