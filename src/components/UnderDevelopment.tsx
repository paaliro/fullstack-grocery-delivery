    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-[#fbf4e4] to-white text-center px-4">
            ...
            <div className="bg-accent/10 p-6 rounded-full mb-6">
                <Construction className="w-16 h-16 text-secondary-yellow" />
            </div>

            {/* Heading */}
            <h1 className="text-3xl md:text-4xl font-bold text-gray-700 mb-4">
                This Page is <span className="text-secondary-yellow">Under Development</span>
            </h1>
            ...
            <Link
                to="/"
                className="px-6 py-2.5 bg-accent text-white rounded-3xl font-semibold hover:bg-accent/90 transition-all">
                Go Back Home
            </Link>
        </div>
    );
