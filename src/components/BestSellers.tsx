...
const BestSellers = () => {
    // shuffle + take first 5 products
    const randomProducts = [...allProductsContent].sort(() => Math.random() - 0.5).slice(0, 5);
                            ...
                            <div className="px-4 md:px-4 py-2">
                                ...
                                <div>
                                    ...
                                    <div className="flex justify-between items-baseline pt-3">
                                        ...
                                        <button onClick={() => { console.log("add to cart:", data) }} className="flex gap-0.5 md:gap-2 border-1 text-xs md:text-lg border-[#feca65] px-1 md:px-3 py-0.5 rounded-md bg-[#fff7e7] text-[#feca65] font-normal cursor-pointer">
